...
function strategy(_space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var blockTag, res, unipoolBalanceOf, unipoolEarned, sumList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    blockTag = typeof snapshot === 'number' ? snapshot : 'latest';
                    return [4 /*yield*/, utils_1.multicall(network, provider, contractAbi, __spreadArrays(addresses.map(function (address) { return [
                ...
                case 1:
                    res = _a.sent();
                    unipoolBalanceOf = res.slice(0, addresses.length).map(function (num) {
                        return bn(num); // decimal: 18
                    });
                    unipoolEarned = res.slice(addresses.length).map(function (num) {
                        return bn(num); // decimal: options.decimal
                    });
                    sumList = unipoolBalanceOf.map(function (userBalanceOf, i) {
