        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, abi, options.tokenIds.map(function (id) { return [options.address, 'ownerOf', [id]]; }), { blockTag: blockTag })];
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, Object.fromEntries(addresses.map(function (address) { return [
                            address,
                            response.findIndex(function (res) { return res.owner.toLowerCase() === address.toLowerCase(); }) > -1 ? 1 : 0,
                        ]; }))];
            }
        });
    });
