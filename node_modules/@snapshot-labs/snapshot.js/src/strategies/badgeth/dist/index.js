...
var BADGETH_SUBGRAPH_URL = 'https://api.thegraph.com/subgraphs/name/hardforksoverknives/badgeth-dev';
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var params, score, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    score = {};
                    return [4 /*yield*/, utils_1.subgraphRequest(BADGETH_SUBGRAPH_URL, params)];
                case 1:
                    result = _a.sent();
                    if (result && result.voters) {
                        result.voters.forEach(function (voter) {
                            score[address_1.getAddress(voter.id)] = parseInt(voter.votingPower);
                        });
                    }
