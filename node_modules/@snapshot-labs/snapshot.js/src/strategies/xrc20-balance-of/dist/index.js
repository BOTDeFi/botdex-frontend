        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (blockTag == 'latest')
                        return [2 /*return*/, erc20_balance_of_1.strategy(space, network, provider, addresses, options, snapshot)];
                    apiUrl = getUrl(network);
                    return [4 /*yield*/, cross_fetch_1["default"](apiUrl + "/api.AccountService.GetErc20TokenBalanceByHeight", {
                            method: 'POST',
                            headers: {
