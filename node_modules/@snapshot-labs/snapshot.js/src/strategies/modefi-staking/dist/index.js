...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var blockTag, stakeResponse;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    blockTag = typeof snapshot === 'number' ? snapshot : 'latest';
                    return [4 /*yield*/, utils_1.multicall(network, provider, stakingPoolAbi, addresses.map(function (address) { return [
                ...
                case 1:
                    ...
                    return [2 /*return*/, Object.fromEntries(stakeResponse.map(function (value, i) {
                            var stakedBalance = stakeResponse[i].amount;
                            return [
                                addresses[i],
                                parseFloat(units_1.formatUnits(stakedBalance.toString(), options.decimals))
                            ];
                        }))];
            }
        });
