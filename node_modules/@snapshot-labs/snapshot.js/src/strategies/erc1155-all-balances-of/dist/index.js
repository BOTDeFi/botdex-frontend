...
exports.strategy = exports.SUBGRAPH_URL = exports.examples = exports.version = exports.author = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, utils_1.subgraphRequest(exports.SUBGRAPH_URL[network], eip1155OwnersParams)];
                case 2:
                    result = _a.sent();
                    return [2 /*return*/, result.accounts.reduce(function (acc, val) {
                            ...
                            acc[address_1.getAddress(val.id)] = relevantTokenBalances.reduce(function (acc, val) { return acc + parseInt(val.value, 10); }, 0);
                            return acc;
                        }, {})];
                case 3:
                    err_1 = _a.sent();
