        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.subgraphRequest(BALANCER_SUBGRAPH_URL[network] + versionString, params)];
                case 2:
                    result = _a.sent();
                        ...
                        result.poolShares.forEach(function (poolShare) {
                            return poolShare.poolId.tokens.map(function (poolToken) {
                                ...
                                if (tokenAddress === options.address.toLowerCase()) {
                                    var userAddress = address_1.getAddress(poolShare.userAddress.id);
