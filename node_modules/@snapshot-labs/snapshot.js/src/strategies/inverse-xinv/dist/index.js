        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, abi, [[xINV, 'exchangeRateStored', []]], { blockTag: blockTag })];
                case 1:
                    exchangeRateResp = _a.sent();
                    exchangeRate = exchangeRateResp[0][0];
                    return [4 /*yield*/, utils_1.multicall(network, provider, abi, addresses.map(function (address) { return [xINV, 'balanceOf', [address]]; }), { blockTag: blockTag })];
                case 2:
                    balanceResp = _a.sent();
                    return [2 /*return*/, Object.fromEntries(balanceResp.map(function (value, i) { return [
                            addresses[i],
                            parseFloat(units_1.formatUnits(value[0].mul(exchangeRate).div(ONE_E18).toString(), options.decimals))
                        ]; }))];
            }
        });
    });
