        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, stakingPoolAbi, addresses.map(function (address) { return [MOD_POOL_ADDRESS, 'userInfo', [address]]; }), { blockTag: blockTag })];
                case 2:
                    ...
                    return [2 /*return*/, Object.fromEntries(balanceResponse.map(function (value, i) {
                            ...
                            return [
                                addresses[i],
                                parseFloat(units_1.formatUnits(sum.toString(), options.decimals))
                            ];
                        }))];
            }
        });
