            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, Object.fromEntries(p1.map(function (values, i) { return [
                            ...
                            parseFloat(units_1.formatUnits(p1[i][0].toString(), 18)) +
                                parseFloat(units_1.formatUnits(p2[i][0].toString(), 18)) +
                                parseFloat(units_1.formatUnits(p3[i][0].mul(tokenBalanceInUni).div(totalSupply).toString(), 18)) +
                                parseFloat(units_1.formatUnits(p4[i][0].mul(tokenBalanceInUni).div(totalSupply).toString(), 18))
                        ]; }))];
            }
        });
    });
