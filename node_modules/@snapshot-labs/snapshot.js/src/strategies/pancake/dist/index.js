    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    score = _a.sent();
                    return [4 /*yield*/, utils_1.multicall(network, provider, masterChefAbi, addresses.map(function (address) { return [
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(options.chefAddresses.map(function (item) {
                            return utils_1.multicall(network, provider, sousChefabi, addresses.map(function (address) { return [
                                item.address,
                                'userInfo',
                                [address],
                                { blockTag: blockTag }
                ...
                case 3:
                    ...
                    return [2 /*return*/, Object.fromEntries(Object.entries(score).map(function (address, index) { return [
                            address[0],
                            address[1] +
                                parseFloat(units_1.formatUnits(masterBalances[index].amount.toString(), 18)) +
                                sousBalances.reduce(function (prev, cur, idx) {
                                    return prev +
                                        parseFloat(units_1.formatUnits(cur[index].amount.toString(), options.chefAddresses[idx].decimals));
                                }, 0)
                        ]; }))];
            }
        });
