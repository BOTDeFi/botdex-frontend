...
function strategy(space, network, provider, addresses, params, snapshot) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, seenAbi, [stakingContractSeenBalanceCallParams], { blockTag: blockTag })];
                case 1:
                    seenRes = _a.sent();
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, xseenAbi, __spreadArrays([[params.tokenAddress, 'totalSupply']], xseenBalanceCallParams), { blockTag: blockTag })];
                case 2:
                    xseenRes = _a.sent();
