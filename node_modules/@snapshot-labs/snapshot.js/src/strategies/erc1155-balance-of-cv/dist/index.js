...
var erc1155_balance_of_1 = require("../erc1155-balance-of");
...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, erc1155_balance_of_1.strategy(space, network, provider, addresses, options, snapshot)];
                case 1:
                    score = _a.sent();
