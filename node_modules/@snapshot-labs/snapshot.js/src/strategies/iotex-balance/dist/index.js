...
var eth_balance_1 = require("../eth-balance");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (blockTag == 'latest')
                        return [2 /*return*/, eth_balance_1.strategy(space, network, provider, addresses, options, snapshot)];
                    apiUrl = getUrl(network);
                    return [4 /*yield*/, cross_fetch_1["default"](apiUrl + "/api.AccountService.GetIotexBalanceByHeight", {
                            method: 'POST',
                            headers: {
