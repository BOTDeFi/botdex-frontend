...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var multipler, params, score, hasNext, result, nfts, _i, nfts_1, estate, userAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.subgraphRequest(DECENTRALAND_MARKETPLACE_SUBGRAPH_URL[network], params)];
                case 2:
                    result = _a.sent();
                    nfts = result && result.nfts ? result.nfts : [];
                    for (_i = 0, nfts_1 = nfts; _i < nfts_1.length; _i++) {
                        estate = nfts_1[_i];
                        userAddress = address_1.getAddress(estate.owner.id);
                        score[userAddress] =
