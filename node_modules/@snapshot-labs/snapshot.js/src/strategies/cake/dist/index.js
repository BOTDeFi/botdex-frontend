 ...
 */
var fetchVotingPower = function (address, block, poolAddresses) { return __awaiter(void 0, void 0, Promise, function () {
    var response, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, cross_fetch_1["default"](VOTING_API_URL, {
                    method: 'POST',
                    body: JSON.stringify({
                        block: block,
                        address: address,
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, utils_1.subgraphRequest(SMART_CHEF_URL, params)];
                case 4:
                    results = _c.sent();
                    if (!results) {
                        return [2 /*return*/];
