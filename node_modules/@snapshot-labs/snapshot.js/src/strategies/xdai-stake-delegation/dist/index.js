...
var xdai_easy_staking_1 = require("../xdai-easy-staking");
var xdai_posdao_staking_1 = require("../xdai-posdao-staking");
var xdai_stake_holders_1 = require("../xdai-stake-holders");
var utils_1 = require("../../plugins/delegation/utils");
...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utils_1.getDelegations(space, network, provider, addresses, options, snapshot)];
                case 1:
                    delegations = _a.sent();
                    ...
                    return [4 /*yield*/, erc20_balance_of_1.strategy(space, network, provider, delegationsArray, options, snapshot)];
                case 2:
                    erc20Balances = _a.sent();
                    return [4 /*yield*/, xdai_easy_staking_1.strategy(space, network, provider, delegationsArray, options, snapshot)];
                case 3:
                    easyStakingBalances = _a.sent();
                    return [4 /*yield*/, xdai_posdao_staking_1.strategy(space, network, provider, delegationsArray, options, snapshot)];
                case 4:
                    posdaoStakingBalances = _a.sent();
                    return [4 /*yield*/, xdai_stake_holders_1.strategy(space, network, provider, delegationsArray, options, snapshot)];
                case 5:
