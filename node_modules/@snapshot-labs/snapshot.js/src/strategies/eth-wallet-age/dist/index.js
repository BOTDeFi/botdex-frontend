...
var getJWT = function (dfuseApiKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, cross_fetch_1["default"]('https://auth.dfuse.io/v1/auth/issue', {
                    method: 'POST',
                    headers: {
...
function strategy(space, network, provider, addresses, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    dfuseJWT = _a.sent();
                    return [4 /*yield*/, utils_1.subgraphRequest('https://mainnet.eth.dfuse.io/graphql', query, {
                            headers: {
