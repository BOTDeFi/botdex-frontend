        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, abi, memberAddresses
                ...
                case 2:
                    ...
                    return [2 /*return*/, Object.fromEntries(response.map(function (value, i) { return [
                            addresses[i],
                            parseFloat(units_1.formatUnits(value.shares.toString(), options.decimals)) +
                                parseFloat(units_1.formatUnits(value.loot.toString(), options.decimals))
                        ]; }))];
            }
        });
    });
