...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var blockTag, multi, score, result;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    addresses.forEach(function (address) {
                        options.pairs.forEach(function (pair, idx) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, Object.fromEntries(Object.entries(score).map(function (address) { return [
                            address[0],
                            address[1] +
                                options.pairs.reduce(function (prev, cur, idx) {
                                    return prev +
                                        parseFloat(units_1.formatUnits(result.lpBalance[idx][address[0]]
                                            .mul(result.pairIFBalance[idx])
                                            .mul(options.pairs[idx].weightNumerator)
                                            .div(result.pairTotalSupply[idx])
                                            .div(options.pairs[idx].weightDenominator), options.pairs[idx].decimals));
                                }, 0)
                        ]; }))];
            }
        });
