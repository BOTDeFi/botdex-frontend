        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.multicall(network, provider, data_reader_abi, addresses.map(function (addr) { return [
                            data_reader_address,
                            'getDaoShares',
                            [addr]
                        ]; }), { blockTag: blockTag })];
                case 1:
                    totalShares = _a.sent();
                    shares_by_address = {};
                    _1e18 = bignumber_1.BigNumber.from('1000000000000000000');
                    totalShares.forEach(function (v, i) {
                        var sharesBN = bignumber_1.BigNumber.from(v.toString());
