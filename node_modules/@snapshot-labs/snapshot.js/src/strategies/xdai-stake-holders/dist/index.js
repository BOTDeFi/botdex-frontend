...
var xdai_stakers_and_holders_1 = require("../xdai-stakers-and-holders");
...
function strategy(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, xdai_stakers_and_holders_1.strategy(space, network, provider, addresses, __assign(__assign({}, options), { userType: 'holders' }), snapshot)];
        });
    });
}
